...
We will be utilizing `titanic.csv` dataset contained in the **data** subdirectory. `titanic_codebook.html` provides a quick overview of the data.
...
When using deletion of data, we may face the choice of deleting predictors (columns) or samples/observations (rows). In general, which should we identify first for removal, predicors or samples with high degree of missingness? Explain.
